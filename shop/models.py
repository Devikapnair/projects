...
class Order(models.Model):
   ...
   city = models.CharField(max_length=150, null=False, default='YourDefaultCity')
   state=models.CharField(max_length=150,null=False, default='YourDefaultState')
   country=models.CharField(max_length=150,null=False,default='YourDefaultCountry' )
